...
with expected_content as (
  ...
  where version.id = (expected.document->'version'->>'id')::uuid
    ...
    and version.content_hash = 'aed8ac0e9482af70fe2d600cd4a1306353f5f1b10e104417c055094cb082f4b3'
