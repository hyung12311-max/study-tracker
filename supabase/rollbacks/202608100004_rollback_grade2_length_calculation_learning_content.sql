-- Pre-use rollback for the grade2-length-calculation v1 pilot content only.
begin;
...
begin
  if exists (
    ...
    raise exception using
      errcode = '55000',
      message = 'rollback blocked: grade2_length_calculation_v1 content has assignment or learning history';
  end if;
...
where mapping.question_id = question.id
  ...
  and stage.content_version_id = '8b54116b-288c-496e-aeb3-5f0dc98b506b'::uuid;
...
where unit.id = 'c4e0df8c-c000-4ff2-aaeb-cfdb13e12746'::uuid
