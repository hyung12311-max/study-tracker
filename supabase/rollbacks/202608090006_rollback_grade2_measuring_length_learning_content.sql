-- Pre-use rollback for the grade2-measuring-length v1 pilot content only.
begin;
...
begin
  if exists (
    ...
    raise exception using
      errcode = '55000',
      message = 'rollback blocked: grade2_measuring_length_v1 content has assignment or learning history';
  end if;
...
where mapping.question_id = question.id
  ...
  and stage.content_version_id = '29ac4fe6-847f-4c01-a402-ffce3440fad7'::uuid;
...
where unit.id = 'ab61feac-d390-4542-9eea-d049b007096d'::uuid
