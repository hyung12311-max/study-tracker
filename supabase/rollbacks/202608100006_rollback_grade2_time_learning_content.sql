-- Pre-use rollback for the grade2-time v1 pilot content only.
begin;
...
begin
  if exists (
    ...
    raise exception using
      errcode = '55000',
      message = 'rollback blocked: grade2_time_v1 content has assignment or learning history';
  end if;
...
where mapping.question_id = question.id
  ...
  and stage.content_version_id = '81f5083b-44b5-4344-8457-9522dbe74c97'::uuid;
...
where unit.id = 'bb6cc6d7-e1e6-46e9-9d56-3bcb4b42550d'::uuid
