-- Pre-use rollback for the grade2-four-digit-numbers v1 pilot content only.
begin;
...
begin
  if exists (
    ...
    raise exception using
      errcode = '55000',
      message = 'rollback blocked: grade2_four_digit_numbers_v1 content has assignment or learning history';
  end if;
...
where mapping.question_id = question.id
  ...
  and stage.content_version_id = '06abbe3b-4061-4afe-84ca-d69122f9d7b8'::uuid;
...
where unit.id = '66bef880-3b26-4dc3-84a6-13986aae72d8'::uuid
