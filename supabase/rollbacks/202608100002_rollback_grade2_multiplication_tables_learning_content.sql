-- Pre-use rollback for the grade2-multiplication-tables v1 pilot content only.
begin;
...
begin
  if exists (
    ...
    raise exception using
      errcode = '55000',
      message = 'rollback blocked: grade2_multiplication_tables_v1 content has assignment or learning history';
  end if;
...
where mapping.question_id = question.id
  ...
  and stage.content_version_id = 'db13b15e-752d-4491-832d-75feb9b9eb21'::uuid;
...
where unit.id = '362cafc9-09b4-4582-a5dd-d6e868e573d6'::uuid
