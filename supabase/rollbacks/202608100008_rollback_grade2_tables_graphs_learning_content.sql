-- Pre-use rollback for the grade2-tables-graphs v1 pilot content only.
begin;
...
begin
  if exists (
    ...
    raise exception using
      errcode = '55000',
      message = 'rollback blocked: grade2_tables_graphs_v1 content has assignment or learning history';
  end if;
...
where mapping.question_id = question.id
  ...
  and stage.content_version_id = 'f37533f2-54b2-4a3d-99da-88ba28dc7af9'::uuid;
...
where unit.id = '41cf53c2-edf0-4585-958e-2d8804c5c443'::uuid
