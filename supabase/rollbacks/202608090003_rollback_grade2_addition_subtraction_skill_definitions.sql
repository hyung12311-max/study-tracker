-- Roll back only unused Grade 2 addition and subtraction skill definitions.
begin;
...
begin
  if exists (
    ...
    raise exception using errcode = '55000', message = 'grade2 addition subtraction skills are in use';
  end if;
end
$guard$;
