-- Pre-use rollback for the grade2-addition-subtraction v1 pilot content only.
begin;
...
begin
  if exists (
    ...
    raise exception using
      errcode = '55000',
      message = 'rollback blocked: grade2_addition_subtraction_v1 content has assignment or learning history';
  end if;
...
where mapping.question_id = question.id
  ...
  and stage.content_version_id = 'd6d3caf7-1375-4dde-9fea-c44b5776cc04'::uuid;
...
where unit.id = '05f6dcf6-c9e3-4f5d-b0cb-60a428a82617'::uuid
