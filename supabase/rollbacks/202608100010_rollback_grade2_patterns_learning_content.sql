-- Pre-use rollback for the grade2-patterns v1 pilot content only.
begin;
...
begin
  if exists (
    ...
    raise exception using
      errcode = '55000',
      message = 'rollback blocked: grade2_patterns_v1 content has assignment or learning history';
  end if;
...
where mapping.question_id = question.id
  ...
  and stage.content_version_id = '5dad60cf-1889-4683-b135-667c885b6851'::uuid;
...
where unit.id = '09bafac3-9711-44dc-aa9d-88e5fc052d15'::uuid
