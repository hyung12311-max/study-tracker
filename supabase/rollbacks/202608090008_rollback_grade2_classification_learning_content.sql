-- Pre-use rollback for the grade2-classification v1 pilot content only.
begin;
...
begin
  if exists (
    ...
    raise exception using
      errcode = '55000',
      message = 'rollback blocked: grade2_classification_v1 content has assignment or learning history';
  end if;
...
where mapping.question_id = question.id
  ...
  and stage.content_version_id = 'bf3dd0af-3cff-4d29-bdd3-f12e2ef08d9d'::uuid;
...
where unit.id = '0a730ea3-c789-4933-8673-c4869b2a2d20'::uuid
